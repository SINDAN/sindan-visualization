  ...
  context "result" do
    ...
    context "with settings of ignore_log_types" do
      ...
      context "diagnosis_log result is fail with ignore_log_types" do
        before(:each) do
          @diagnosis_log = FactoryGirl.create(:diagnosis_log, log_campaign: @log_campaign, result: :fail, log_type: 'v4http_srv')
        end
      ...
      context "diagnosis_log result is fail without ignore_log_types" do
        before(:each) do
          @diagnosis_log = FactoryGirl.create(:diagnosis_log, log_campaign: @log_campaign, result: :fail, log_type: 'other')
        end
